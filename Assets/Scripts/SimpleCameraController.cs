...
namespace UnityTemplateProjects
{
    public class SimpleCameraController : MonoBehaviour
    {
        ...
        Vector3 GetInputTranslationDirection()
        {
            ...
            {
                if (mainCamera.orthographic) { direction += Vector3.down; } else { direction += Vector3.forward; }
                
            }
            if (Input.GetKey(KeyCode.S))
            {
                if (mainCamera.orthographic) { direction += Vector3.up; } else { direction += Vector3.back; }               
            }
            ...
            if (Input.GetKey(KeyCode.Q) && !mainCamera.orthographic)
            {
                direction += Vector3.down;
            }
            if (Input.GetKey(KeyCode.E) && !mainCamera.orthographic)
            {
        ...
        void Update()
        {
            ...
            // Rotation
            if (Input.GetMouseButton(1) && !mainCamera.orthographic)
            {
